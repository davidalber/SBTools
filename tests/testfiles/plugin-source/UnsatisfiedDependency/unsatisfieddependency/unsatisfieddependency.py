...
class UnsatisfiedDependency(SBTool):
    """UnsatisfiedDependency test plug-in."""
    def __init__(self, sbtools):
        self.sbtools = sbtools
        self.command = "unsatisfied-dependency"
        self.altcmds = ['ud']
    ...
    def get_about(self):
        ...
        return """This test plug-in exists to verify that SBTools behaves correctly when it attempts to load a plug-in for which some dependencies are not satisfied."""
